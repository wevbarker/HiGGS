...
## What is `HiGGS`?
`HiGGS` is a Mathematica package for the xAct tensor algebra suite, which implements the Dirac-Bergmann algorithm across the space of possible gauge gravity theories.

<img src="lagrangian-1.png" width="1000">\\
